...
- Patron backend/frontend registrado: la carga de datos de prueba para operacion integral debe exponerse como accion administrativa protegida por JWT y rol `admin`, ser idempotente para evitar duplicados, y poblar al menos usuarios/roles, restaurante/mesas/menu, sesiones/pedidos/solicitudes, pagos/caja/comprobantes/fiscalizacion, reservas y bitacora para validar todos los modulos desde UI.
